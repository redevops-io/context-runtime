...
- eval/context_runtime_eval.py and most examples/ build small hand-written corpora inline. The Russian medical-lab PDFs referenced in eval/context_runtime_eval.py are a private/personal corpus, not a public dataset, and are not redistributed.
