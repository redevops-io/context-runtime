"""HippoRAG × ContextOS — the multi-hop (graph) RetrieverPlugin (SPEC §4.5).
...
Install the real engine:  pip install "contextos[hipporag]"
"""
...
class HippoRAGRetriever:
    ...
    def __init__(self, save_dir: str = ".contextos/hipporag", llm_model_name: str = "gpt-4o-mini",
    ...
    def _get(self):
        if self._hr is None:
            try:
                ...
                raise RuntimeError("HippoRAGRetriever needs: pip install 'contextos[hipporag]'") from e
