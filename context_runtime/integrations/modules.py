"""The business-module fleet — every agentic module as a Context Runtime tenant.

The old agentic-os ran a fleet of hand-wired module controllers. Context Runtime replaces
that with one pattern: each module is a **tenant** with a *goal* (answer its domain
question) and a *metric* (its own success signal), and Context Runtime learns the cheapest
...
def build_fleet(runtime: ContextRuntime | None = None, approver=None) -> dict[str, ModuleTenant]:
    """Instantiate the whole catalog as Context Runtime tenants — the migrated fleet."""
