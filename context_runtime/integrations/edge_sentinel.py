"""edge-sentinel × Context Runtime — the cybersecurity SOC tenant (first tool-using tenant).
...
class SOCTriageTenant:
    """Context Runtime plans SOC triage: pick the cheapest source bundle that resolves the
