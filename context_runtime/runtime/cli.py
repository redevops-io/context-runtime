"""context_runtime CLI — run / explain / simulate / index over a folder corpus."""
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(prog="context_runtime", description="Query planner for LLM context.")
    p.add_argument("--config", help="path to context_runtime.yaml")
