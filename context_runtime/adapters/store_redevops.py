...
Install:  pip install "context_runtime[rag]"
"""
...
class RedevopsRagRetriever:
    def __init__(self, db_path: str = "./context_runtime_rag.duckdb", use_reranker: bool = False,
                 source: str = "docs"):
    ...
    def _get(self):
        if self._rag is None:
            try:
                ...
                raise RuntimeError(
                    "RedevopsRagRetriever needs the 'rag' extra: pip install 'context_runtime[rag]'"
                ) from e
